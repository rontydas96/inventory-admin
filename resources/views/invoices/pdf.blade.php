...
<body>
  ...
  @php
    ...
    @php
        $logoPath = !empty($setting->logo) ? public_path('storage/' . $setting->logo) : null;
    @endphp
      ...
      <table class="products-table">
        <thead>
          <tr class="header-main-row">
            ...
            <th class="col-hsn" rowspan="2">SKU</th>
          ...
          <tr class="header-sub-row">
            <th class="col-cgst-rate">Rate</th>
            <th class="col-cgst-amt">Amount</th>
          </tr>
          <tr>
            <td colspan="11" class="table-section-title">&#9665; Products Supplied &#9665;</td>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td>{{ $index + 1 }}</td>
            <td class="left-align desc-text">{{ $item->product_name }}</td>
            <td>{{ $item->sku }}</td>
            <td>{{ optional($item->product)->unit ?? '-' }}</td>
            <td>{{ number_format($item->unit_price, 2) }}</td>
            <td>{{ $item->quantity }}</td>
            <td class="right-align" style="font-weight:700; color:var(--primary-dark-teal);">{{ number_format($item->line_total, 2) }}</td>
            <td>{{ number_format($item->gst_percentage, 2) }}%</td>
            <td class="right-align">{{ number_format($item->gst_amount, 2) }}</td>
          </tr>
          @endforeach
          ...
          <tr class="total-row">
            <td colspan="6" class="right-align" style="padding-right:var(--space-8); letter-spacing:0.5px;">TOTAL AMOUNT
              (Rs.)</td>
            <td class="right-align">92,200.00</td>
            <td>9%</td>
            <td class="right-align">8,298.00</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="bottom-grid">
      <div class="bottom-left-panel">
        <div class="bank-details-box">
          ...
          <div class="bank-line"><span class="bank-line-bold">Name: M/S. Universal Suppliers,</span></div>
          <div class="bank-line">Bank Name: <span class="bank-line-bold">State Bank Of India</span>, A/C No: <span
              class="bank-line-bold">42981893787</span></div>
          <div class="bank-line">Branch Name: <span class="bank-line-bold">GumaHarispur</span>, IFSC Code: <span
              class="bank-line-bold">SBIN0016643</span></div>
        ...
        <div class="words-amount-box">
          ...
          <div class="words-val">One Lacs Eight Thousand and Seven Hundred Ninety Six Rupees and No Paise</div>
        </div>
      </div>
      <div class="cost-summary-panel">
        ...
        <div class="cost-row"><span class="cost-label">GST &nbsp;@18%</span><span class="cost-val">&#8377; {{ number_format($sale->gst_amount, 2) }}</span></div>
